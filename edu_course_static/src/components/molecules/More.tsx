...
export default function MoreMenu() {
  ...
  // ✅ Tutup otomatis ketika klik di luar
  useEffect(() => {
    function handleClickOutside(event: MouseEvent) {
      const target = event.target as Node;
      const clickedOutsideSheet =
          ...
          <div className="px-6">
            <ul className="text-sm text-gray-700">
              <li
                ...
                className="border-t border-gray-200 py-3 cursor-pointer hover:text-yellow-600"
              >
                Kategori
              </li>
              ...
              <li className="border-t border-gray-200 py-3 text-red-600 flex items-center gap-2 cursor-pointer hover:text-red-700">
                Keluar
                <button onClick={() => navigate("/")} aria-label="Logout">
