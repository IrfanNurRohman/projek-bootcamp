...
const RegisterPage: React.FC<AuthCardProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      // Mengirimkan permintaan GET ke API dengan query parameters
      const response = await axios.get("https://mocki.io/v1/4301479f-36d2-476d-b3d2-43882e926331", {
        params: {
          name,
          email,
          password,
      ...
      // Periksa apakah respons mengandung "LOGIN SUCCESS"
      if (response.data && response.data.includes("LOGIN SUCCES")) {
