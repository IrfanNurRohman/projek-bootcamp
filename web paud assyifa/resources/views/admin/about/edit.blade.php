...
<section class="section">
	<div class="section-header">
		...
		<div class="section-header-breadcrumb">
			<div class="breadcrumb-item"><a href="{{ route('admin.about.update', $about->id) }}">Home</a></div>
		...
		<div class="row">
			<div class="col-md-12">
              ...
              <div class="form-group">
								...
								<textarea id="editor_forum" name="desc" class="form-control @error('content') is-invalid @enderror" style="height: 150px">{{ $about->desc }}</textarea>
								@error('desc')
