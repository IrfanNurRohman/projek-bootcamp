...
<section class="section">
	<div class="section-header">
		...
		<div class="section-header-breadcrumb">
			<div class="breadcrumb-item"><a href="{{ route('admin.event.update', $event->id) }}">Home</a></div>
	...
	<div class="section-body">
		<div class="row">
			<div class="col-md-12">
					...
					<div class="card-body">
						...
						<form action="{{ route('admin.event.update', $event->id) }}" method="post" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<input type="text" name="title" value="{{ $event->title }}" class="form-control @error('title') is-invalid @enderror" required>
								@error('title')
							...
							<div class="form-group">
								...
								<textarea name="desc" class="form-control @error('desc') is-invalid @enderror" style="height: 150px">{{ $event->desc }}</textarea>
								@error('desc')
								<span class="invalid-feedback" role="alert">
									<strong>{{ $message }}</strong>
								</span>
              ...
              <div class="form-group">
								<img src="/events/{{ $event->photo }}" style="padding: 5px; width: 150px;" alt="Event"></td>
							</div>
							<div class="form-group">
