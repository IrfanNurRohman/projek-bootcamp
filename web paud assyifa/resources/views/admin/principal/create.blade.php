...
<section class="section">
	<div class="section-header">
		...
		<h1 class="m-0 text-dark">Add New principal</h1>
			...
			<div class="col-md-12">
				<div class="card">
					...
					<div class="card-body">
						...
						<form action="{{ route('admin.principal.store') }}" method="post" enctype="multipart/form-data">
							@csrf
							...
							<div class="form-group">
								<label for="">Deskripsi atau sambutan</label>
