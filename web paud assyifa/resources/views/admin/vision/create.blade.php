...
<section class="section">
	<div class="section-header">
		...
		<h1 class="m-0 text-dark">Add New visi dan misi</h1>
		...
		<div class="row">
			<div class="col-md-12">
					...
					<div class="card-body">
						...
						<form action="{{ route('admin.vision.store') }}" method="post">
							...
							<div class="form-group">
								...
								<textarea id="editor_forum" name="vision" class="form-control @error('content') is-invalid @enderror" style="height: 150px"></textarea>
								@error('vision')
              ...
              <div class="form-group">
								...
								<textarea id="editor_forum2" name="mision" class="form-control @error('content') is-invalid @enderror" style="height: 150px"></textarea>
								@error('mision')
								<span class="invalid-feedback" role="alert">
									<strong>{{ $message }}</strong>
								</span>
