...
<section class="section">
	<div class="section-header">
		...
		<div class="section-header-breadcrumb">
			<div class="breadcrumb-item"><a href="{{ route('admin.vision.update', $vision->id) }}">Home</a></div>
		...
		<div class="row">
			<div class="col-md-12">
              ...
              <div class="form-group">
								...
								<textarea id="editor_forum" name="vision" class="form-control @error('content') is-invalid @enderror" style="height: 150px">{!! $vision->vision !!}</textarea>
								@error('vision')
              ...
              <div class="form-group">
								...
								<textarea id="editor_forum2" name="mision" class="form-control @error('content') is-invalid @enderror" style="height: 150px">{!! $vision->mision !!}</textarea>
								@error('mision')
								<span class="invalid-feedback" role="alert">
									<strong>{{ $message }}</strong>
								</span>
